package com.pahanez.custom.mvp.delegate.presentermanager;
...
/**
 *
 * TODO check injection possibility plus https://github.com/tinmegali/simple-mvp/blob/master/AndroidMVP/mvp/src/main/java/com/tinmegali/mvp/mvp/StateMaintainer.java
 * TODO activity cache can be created via activity module with dagger
 * TODO check possibity to inject each activity with help of ActivityLifecycleCallbacks
 *
 * build component and inject
 *
